...
interface SangjitGallerySectionProps {
  images?: string[];
}
    ...
    <div className="flex gap-3 w-full aspect-square">
      ...
      <div className="flex flex-col gap-3 flex-1">
        <motion.div 
          ...
          className="flex-[0.4] rounded-xl overflow-hidden relative cursor-pointer hover:scale-[1.02] active:scale-95 transition-transform shadow-sm bg-[#5a1427]"
        ...
        <motion.div 
          ...
          className="flex-[0.6] rounded-xl overflow-hidden relative cursor-pointer hover:scale-[1.02] active:scale-95 transition-transform shadow-sm bg-[#5a1427]"
      ...
      <div className="flex flex-col gap-3 flex-1">
        <motion.div 
          ...
          className="flex-[0.55] rounded-xl overflow-hidden relative cursor-pointer hover:scale-[1.02] active:scale-95 transition-transform shadow-sm bg-[#5a1427]"
        ...
        <div className="flex-[0.45] flex gap-3">
          <motion.div 
            ...
            className="flex-1 rounded-xl overflow-hidden relative cursor-pointer hover:scale-[1.02] active:scale-95 transition-transform shadow-sm bg-[#5a1427]"
...
export function SangjitGallerySection({ images = [] }: SangjitGallerySectionProps) {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      <motion.h2 
        ...
        className="text-[54px] text-white mb-10 leading-none" 
        style={{ fontFamily: "var(--font-egizio)" }}
      >
        {t('ourMoments')}
      </motion.h2>
            ...
            <>
              {topHeroImage && (
                <motion.div 
                  ...
                  className="cursor-pointer overflow-hidden rounded-xl transition-transform hover:scale-[1.02] active:scale-95 shadow-sm bg-[#5a1427] w-full aspect-[4/3]"
